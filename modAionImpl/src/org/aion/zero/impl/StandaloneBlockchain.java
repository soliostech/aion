...
public class StandaloneBlockchain extends AionBlockchainImpl {
    ...
    public synchronized Pair<ImportResult, AionBlockSummary> tryToConnectRootPriviledges(AionBlock block) {
        return tryToConnectAsRoot(block, System.currentTimeMillis() / 1000);
    }
