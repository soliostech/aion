...
public class AionBlockchainImpl implements IAionBlockchain {
    ...
    public Pair<ImportResult, AionBlockSummary> tryToConnectAsRoot(AionBlock block, long currTimeSeconds) {
    ...
    ImportResult tryToConnectInternal(final AionBlock block, long currTimeSeconds) {
        return tryToConnectAsRoot(block, currTimeSeconds).getLeft();
    }
